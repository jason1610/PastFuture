...
<style>
	...
	.inner-monitor {
		...
		box-shadow: inset 0 15px 10px 0 rgba(0, 0, 0, 0.2);
	}
	...
	.sticker {
		background-color: rgba(190, 169, 169, 0.671);
		border-radius: 2px;
		width: 80%;
		aspect-ratio: 1;
		padding: 10px;
	...
	.terminal {
		...
		aspect-ratio: 1;
		overflow: hidden;
		box-shadow: 0 0 50px 0px rgba(255, 255, 255, 0.6), 0 0 0 5px rgb(80, 80, 67);
	}
